...
import { View, FlatList, StyleSheet, Text, TouchableOpacity, Linking } from 'react-native';
        ...
        axios
          ...
          .then((res) => {
            ...
            axios
              ...
              .then((res) => {
                console.log(res.data);
                Linking.openURL(`https://accept.paymob.com/api/acceptance/iframes/837986?payment_token=${res.data.token}`);
                // window.open(
